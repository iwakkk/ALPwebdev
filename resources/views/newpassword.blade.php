                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="position-relative mx-auto">
                            ...
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="password" placeholder="New Password" style="margin-bottom: 10px;" id="createpassword">
                        </div>
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="password" placeholder="Confirm Password" id="email">
                            <button type="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;"><a href="{{ url('/login') }}" class="text-white text-decoration-none">Change Password</a></button>
                        </div>

            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h1 class="mb-5 display-3 text-primary">Register</h1>
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" placeholder="Full Name" style="margin-bottom: 10px;" id="fullname">
                            
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" placeholder="Email" style="margin-bottom: 10px;" id="email">
                            
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" placeholder="Username" style="margin-bottom: 10px;" id="username">
                            
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="password" placeholder="Create Password" style="margin-bottom: 10px;" id="createpassword">
                        </div>
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="password" placeholder="Confirm Password" id="password">
                            <button type="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;">Create Account</button>
                        </div>
                        <h4 class="mb-3 text-secondary" style="margin-top: 10px; margin-left: 5px;"><a href="{{ url('/login') }}">Already Have An Account?</a></h4>
                    </div>

...
<html lang="en">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" placeholder="Email" id="email">
    ...
    <a href="{{ url('/newpassword') }}" style="color: white; text-decoration: none;">Send Verification Code</a>
</button>
                        </div>

            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="password" placeholder="Password" id="password">
                            <button type="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;">Login</button>
                        </div>
                        ...
                        <div style="display: flex;">
                            <h4 class="mb-3 text-secondary" style=" margin-left: 5px;"><a href="{{ url('/register') }}">Create Account</a></h4>
                            <h4 class="mb-3 text-secondary" style=" margin-left: 50px;"><a href="{{ url('/forgotpassword') }}">Forgot Password</a></h4>
                        </div>
                    </div>
